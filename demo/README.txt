Reconstruction demo
1. Run the script 'run.sh' at the commandline. Edit 'run.sh' to change run time options.
2. The run-time options (command line options for 'XT_Main') are explained below.
3. The matlab scripts 'display_input_data.m' and 'display_output_data.m' can be used to visualize the input and output binary data. 
